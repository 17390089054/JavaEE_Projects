                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span>
                            <img alt="头像加载失败" class="img-circle" style="width:60px;height:60px;"  
                            onerror="this.src='resource/img/a8.jpg'"
                            src="${sessionUser.userPhoto }" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">${sessionUser.userName }</strong></span>
                                <span class="text-muted text-xs block">
                                ${sessionUser.role.roleName }<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a class="J_menuItem" href="javascript:;">修改密码</a>
                                </li>
    ...
    <script>
    	$(document).ready(function(){
    		$(".logout").click(function(){
    		    parent.layer.confirm('就要离开吗？', {
    		        btn: ['狠心抛下','我再想想'], //按钮
    		        shade: 0.1, //不显示遮罩
    		        shift:6//动画
    		    }, function(){
					window.top.location='sys/logout';
    		    }, function(){
    		        parent.layer.close();
    		    }); 
