        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal" action="sys/user/photo" enctype="multipart/form-data" id="userForm">
                        <div class="form-group">
                            <div class="col-sm-4">
                                <img id="showImage" alt="image" src="resource/photo/${user.userPhoto}" class="img-responsive" onerror="src='resource/img/profile_big.jpg'" style="width: 220px;height: 220px;">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-2">
            ...
            $(function () {
                ...
                $("#myfile").change(function () {
                    ...
                    layer.confirm('您确定要更新头像操作吗？', {
                        ...
                        $("#myfile").val("");
                        $("#showImage").attr("src","resource/img/profile_big.jpg");
                    });
                })
            });
