...
<body class="ecommerce">
   ...
   <div class="main">
      <div class="container">
          ...
          <div class="col-md-12 col-sm-10">
            ...
            <div class="row product-list">
             <c:forEach items="${addrList}" var="l" varStatus="v">
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item c">
                  ...
                  <div class="test">
					<c:if test="${v.count eq fn:length(addrList)}">
					...
					<c:if test="${v.count < fn:length(addrList)}">
              ...
              <div class="goods-data clearfix">
                  ...
                  <tr>
                    ...
                    <td class="goods-page-quantity">
                      <div class="product-quantity">
                          <input id="product-quantity" type="number" min="1" value="${num}"  onchange="getTotal(this.value,${goods.g_price})" readonly class="form-control input-sm">
                      </div>
                    </td>
                    ...
                    <td class="goods-page-total">
                      <strong class="price"><span>￥</span>${goods.g_price*num}</strong>
                    </td>
                ...
                <div class="shopping-total">
                  <ul>
                    <li>
                      <em>商品总金额</em>
                      <strong class="price"><span>￥</span>${goods.g_price}</strong>
                    </li>
                    <li>
                      <em>快递</em>
                    ...
                    <li class="shopping-total-price">
                      <em>订单总价</em>
                      <strong  class="gprice"><span>￥</span>${goods.g_price +10}</strong>
                    </li>
                  </ul>
                </div>
              </div>
             <button class="btn btn-primary" type="button" onclick="addOrder(${goods.g_id},${goods.g_price},2)">立即支付<i class="fa fa-check"></i></button>
             <button class="btn btn-primary" type="button" onclick="addOrder(${goods.g_id},${goods.g_price},1)">稍后支付<i class="fa fa-check"></i></button> 
           </div>
          </div>
          <!-- END CONTENT -->
        </div> 
	...
	//添加订单主方法
	function addOrder(g_id,g_price,num){//num 点击提交订单的类型  1稍后支付  2立即支付
		...
		//获取运费
		var tip=$(".tips").html();
		var total=(parseFloat(g_price)+parseFloat(tip)).toFixed(2);
	...
	//ajax提交订单申请
	function addToOrder(g_id,num,total){
		
		   $.post("addOrder.a",{"a_id":addr_id,"g_id":g_id,"totalPrice":total,"num":num},function(data){
				if(data.flag){
