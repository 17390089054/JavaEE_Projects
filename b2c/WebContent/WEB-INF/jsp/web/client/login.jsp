...
<!-- 	  <script>if(window.top !== window.self){ window.top.location = window.location;}</script>
 -->	</head>
	        ...
	        <div class="row">
	            ...
	            <div class="col-sm-5">
	                <form method="post" action="clientLogin" id="myForm">
	                    ...
	                    <a  onclick="sendCode(this)" >忘记密码了?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<script>
		...
		//验证账号是否存在
		$.post("checkAccount",{"c_account":c_account},function(data){
			if(data.flag){
				$(obj).attr("href","findPsw?c_account="+c_account); 
			}else{
				$("#msg").html(data.msg);
			}			
		},"json");
