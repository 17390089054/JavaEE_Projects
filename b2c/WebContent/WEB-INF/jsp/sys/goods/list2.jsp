...
<head>
    ...
    <!-- jqgrid-->
    <link href="resource/css/plugins/jqgrid/ui.jqgrid.css?0820" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <!-- jqGrid -->
    <script src="resource/js/plugins/jqgrid/i18n/grid.locale-cn.js?0820"></script>
    <script src="resource/js/plugins/jqgrid/jquery.jqGrid.min.js?0820"></script>
    <!-- 自定义js -->
