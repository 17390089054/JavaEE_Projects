            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                    	<!-- 表单 -->
                    <form id="myForm" method="post" action="goodsRevise.do" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                	...
                                	<img id="img-change" src="${goods.g_logo}" width="200px" height="200px" onclick="fileClick()"/>
                                </div>
                                <input type="hidden" name="old_g_logo" value="${old_g_logo}">
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品名称</label>

                                <div class="col-sm-5">
                                    <input type="text" name="g_name" id="g_name" value="${goods.g_name}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                   				...
                                   				<optgroup label="${parent.gt_name }">
	                                   				<c:forEach items="${childList }" var="child">
	                                   					<c:if test="${parent.gt_id==child.gt_parent_id }">
	                                   						<option value="${child.gt_id }" <c:if test="${goods.g_type_id eq child.gt_id}">selected</c:if>>${child.gt_name }</option>
	                                   					</c:if>
	                                   				</c:forEach>
	                                   			</optgroup>
                                   			</c:forEach>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" name="g_price" id="g_price" min="0" value="${goods.g_price}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="number" name="g_number" id="g_number" value="${goods.g_number}" min="0" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="g_addr" id="g_address"  value="${goods.g_addr }" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="editor" name="g_desc"  autofocus>${goods.g_desc }</textarea>
                                </div>
                            </div>
...
<script type="text/javascript">
	function toSub(){
		...
		var g_logo = $.trim($("#img-change").attr("src"));
		...
		$("#myForm").submit();
		console.log($("input[name='old_g_logo']").val());
